        ...
        <div className='our_img'>
          ...
          <div className='defult_img'>
            {activeImge === 'defult' ? (
              ...
              >
                <img
                  src='https://www.course-api.com/images/store/product-5.jpeg'
                  alt='defult'
                />
              </div>
            ) : (
          ...
          <div className='selected_attintion'>
            <div className='select_color'>
              ...
              <div className='spanes'>
                ...
                <button
                  onClick={() => setActiveBtn('thirtyBtnActive')}
                  className={`colorRed ${
                    activeBtn === 'thirtyBtnActive' ? 'activeBtn' : ''
                  }`}
                >
                  {activeBtn === 'thirtyBtnActive' ? (
                    <i className='icon'>
                      <GrFormCheckmark />
                    </i>
                  ) : (
